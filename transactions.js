(function(){
  ...
  window.sbiPayTransactions={read,write,add,formatDate,statusLabel,amountLabel,accountSummary,buyerId,lockOrder,releaseOrder,readMarketOrders,writeMarketOrders,seedMarketOrders,verifyUtr,submitOrder,upsertPurchase,completePurchase,timeoutPurchase,cancelPurchase,subscribe};
})();
